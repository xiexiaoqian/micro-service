package com.soft1851.user.center.utils;
...
public class JwtOperator {
     ...
     * 秘钥
     */
    @Value("${secret:mmmmmmmmnnnnnnnnccccccccxxxxxxxx2}")
...
//        jwtOperator.secret = "mmmmmmmmnnnnnnnnccccccccxxxxxxxx2";
//
////      // 2.设置用户信息
//        HashMap<String, Object> objectObjectHashMap = Maps.newHashMap();
//        objectObjectHashMap.put("id", "1");
//        objectObjectHashMap.put("wxNickname", "喵");
...
//      // 将这串字符还原为上面生成的token!!!
//        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoidXNlciIsInd4Tmlja25hbWUiOiLllrUiLCJpZCI6IjEiLCJpYXQiOjE2MDI2NDAwMzIsImV4cCI6MTYwMzg0OTYzMn0.4IEOKSXcv0_A3LIema09aKjD3mO_MgpmHEiXT_0LWN0";
